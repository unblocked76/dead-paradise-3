    ...
    ***************************************************************************** */
    ...
    var CordovaGamedistribution$$1 = /** @class */ (function () {
        ...
        CordovaGamedistribution$$1.prototype.setAdListeners = function () {
            ...
            cordova.plugins.gdApi.setAdListener(function (data) {
                ...
                switch (data.event) {
                    case 'BANNER_STARTED':
                        _this.adManager.emit(AdEvents.CONTENT_PAUSED);
                        break;
                    case 'API_IS_READY':
                        // Send post init
                    ...
                    case 'API_NOT_READY':
                    case 'BANNER_FAILED':
                        _this.adManager.emit(AdEvents.CONTENT_RESUMED);
                        break;
                }
            }, function (error) {
            ...
            switch (adType) {
                case AdType.interstitial:
                    ...
                    HeyzapAds.InterstitialAd.addEventListener(HeyzapAds.InterstitialAd.Events.HIDE, function () {
                        _this.adManager.emit(AdEvents.CONTENT_RESUMED, HeyzapAds.InterstitialAd.Events.HIDE);
                    });
                    HeyzapAds.InterstitialAd.addEventListener(HeyzapAds.InterstitialAd.Events.SHOW_FAILED, function () {
                        _this.adManager.emit(AdEvents.CONTENT_RESUMED, HeyzapAds.InterstitialAd.Events.SHOW_FAILED);
                    });
                    HeyzapAds.InterstitialAd.addEventListener(HeyzapAds.InterstitialAd.Events.CLICKED, function () {
                        _this.adManager.emit(AdEvents.AD_CLICKED, HeyzapAds.InterstitialAd.Events.CLICKED);
                    });
                ...
                case AdType.interstitial:
                    HeyzapAds.VideoAd.addEventListener(HeyzapAds.VideoAd.Events.HIDE, function () {
                        _this.adManager.emit(AdEvents.CONTENT_RESUMED, HeyzapAds.VideoAd.Events.HIDE);
                    });
                    HeyzapAds.VideoAd.addEventListener(HeyzapAds.VideoAd.Events.SHOW_FAILED, function () {
                        _this.adManager.emit(AdEvents.CONTENT_RESUMED, HeyzapAds.VideoAd.Events.SHOW_FAILED);
                    });
                    HeyzapAds.VideoAd.addEventListener(HeyzapAds.VideoAd.Events.CLICKED, function () {
                        _this.adManager.emit(AdEvents.AD_CLICKED, HeyzapAds.VideoAd.Events.CLICKED);
                    });
                ...
                case AdType.rewarded:
                    HeyzapAds.IncentivizedAd.addEventListener(HeyzapAds.IncentivizedAd.Events.HIDE, function () {
                        _this.adManager.emit(AdEvents.CONTENT_RESUMED, HeyzapAds.IncentivizedAd.Events.HIDE);
                    });
                    HeyzapAds.IncentivizedAd.addEventListener(HeyzapAds.IncentivizedAd.Events.SHOW_FAILED, function () {
                        _this.adManager.emit(AdEvents.CONTENT_RESUMED, HeyzapAds.IncentivizedAd.Events.SHOW_FAILED);
                    });
                    HeyzapAds.IncentivizedAd.addEventListener(HeyzapAds.IncentivizedAd.Events.CLICKED, function () {
                        _this.adManager.emit(AdEvents.AD_CLICKED, HeyzapAds.IncentivizedAd.Events.CLICKED);
                    });
    ...
    var GameDistribution$$1 = /** @class */ (function () {
        ...
        GameDistribution$$1.prototype.sdkLoaded = function () {
            ...
            this.areAdsEnabled().then(function (enabled) {
                if (enabled) {
                    _this.adsEnabled = true;
                    _this.adManager.emit(AdEvents.AD_PROVIDER_LOADED);
                }
            });
        };
        GameDistribution$$1.prototype.showAd = function (adType) {
            ...
            if (!this.adsEnabled) {
                ...
                gdsdk
                    .showAd(adType === AdType.rewarded
                    ? GameDistributionAdType.rewarded
                    : GameDistributionAdType.interstitial)
                    .then(function () {
                    if (adType === AdType.rewarded) {
                        _this.adManager.emit(AdEvents.AD_REWARDED);
                        _this.hasRewarded = false;
                    }
                    _this.adManager.emit(AdEvents.CONTENT_RESUMED);
                })
                    .catch(function () {
                    if (adType === AdType.rewarded && _this.hasRewarded) {
                        _this.hasRewarded = false;
                    }
                    _this.adManager.emit(AdEvents.CONTENT_RESUMED);
                });
        ...
        GameDistribution$$1.prototype.preloadAd = function (adType) {
            ...
            gdsdk.preloadAd(GameDistributionAdType.rewarded).then(function () {
                ...
                _this.adManager.emit(AdEvents.AD_LOADED, adType);
            });
        };
    ...
    var Ima3$$1 = /** @class */ (function () {
        ...
        Ima3$$1.prototype.showAd = function (adType, customParams) {
            ...
            if (!this.adsEnabled) {
                this.adManager.emit(AdEvents.AD_DISABLED, true);
            }
        ...
        CocoonAds$$1.prototype.preloadAd = function (adType, adId, bannerPosition) {
            ...
            if (adType === AdType.banner) {
                ...
                this.banner.on('click', function () {
                    _this.adManager.emit(AdEvents.AD_CLICKED, AdType.banner);
                });
            ...
            if (adType === AdType.interstitial) {
                ...
                this.interstitial.on('click', function () {
                    _this.adManager.emit(AdEvents.AD_CLICKED, AdType.interstitial);
                });
                this.interstitial.on('show', function () {
                    _this.adManager.emit(AdEvents.CONTENT_PAUSED, AdType.interstitial);
                });
                this.interstitial.on('dismiss', function () {
                    _this.adManager.emit(AdEvents.CONTENT_RESUMED, AdType.interstitial);
                    _this.interstitialShowable = false;
                    _this.interstitial = null;
                });
            ...
            if (adType === AdType.rewarded) {
                ...
                this.insentive.on('click', function () {
                    _this.adManager.emit(AdEvents.AD_CLICKED, AdType.rewarded);
                });
                this.insentive.on('show', function () {
                    _this.adManager.emit(AdEvents.CONTENT_PAUSED, AdType.rewarded);
                });
                this.insentive.on('dismiss', function () {
                    _this.adManager.emit(AdEvents.CONTENT_RESUMED, AdType.rewarded);
                    _this.insentiveShowable = false;
                    _this.insentive = null;
                });
                this.insentive.on('reward', function () {
                    _this.adManager.emit(AdEvents.AD_REWARDED, AdType.rewarded);
                    _this.insentiveShowable = false;
                    _this.insentive = null;
                });
                this.insentive.load();
    ...
    var H5AdWrapper$1 = /** @class */ (function (_super) {
        __extends(H5AdWrapper, _super);
        function H5AdWrapper() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.bannerActive = false;
    ...
    var adWrapper$1 = new H5AdWrapper$1();

    exports.H5AdWrapper = H5AdWrapper$1;
    exports.adWrapper = adWrapper$1;
...
var __extends=this&&this.__extends||function(a,b){function c(){this.constructor=a}for(var d in b)b.hasOwnProperty(d)&&(a[d]=b[d]);a.prototype=null===b?Object.create(b):(c.prototype=b.prototype,new c)},PhaserCachebuster;!function(a){var b=function(a){function b(b,c){var d=a.call(this,b,c)||this;return d.patchLoader(),d}return __extends(b,a),b.prototype.patchLoader=function(){Object.defineProperty(Phaser.Loader,"cacheBuster",{value:null}),Phaser.Loader.prototype.transformUrl=function(a,b){return a?(null!==this.cacheBuster&&null===a.match(/^(data:)/)&&(a+="?v="+this.cacheBuster),a.match(/^(?:blob:|data:|http:\/\/|https:\/\/|\/\/)/)?a:this.baseURL+b.path+a):""}},b}(Phaser.Plugin);a.CacheBuster=b}(PhaserCachebuster||(PhaserCachebuster={}));;(function (global, factory) {
	...
	*/
	...
	var auto = es6Promise$1.polyfill();
	...
	(function (BrandingDomain) {
	    ...
	    BrandingDomain[BrandingDomain["Spil"] = 8] = "Spil";
	...
	var Branding$$1 = /** @class */ (function () {
	    ...
	    Branding$$1.preload = function (version) {
	        ...
	        Promise.all([
	            ...
	            Loader.instance.load(Branding$$1.GAME_ICONS_KEY, Utils.ASSET_LOCATION + "json/games.json?v=" + version, 'text/plain')
	        ]);
	        return promise
	            .then(function (data) {
	            var domains = data[0];
	        ...
	        get: function () {
	            ...
	            switch (Utils.getBrandingDomain()) {
	                ...
	                case exports.BrandingDomain.Yepi:
	                    imageName = 'yepi';
	                    break;
	                case exports.BrandingDomain.Spil:
	                    imageName = 'spil';
	                    break;
	    ...
	    /**
	     * Due to Spil loading the games trough a special frame we can't use the default logic in some places
	     * We use this check when setting up the host
	     *
	     * @returns {boolean}
	     */
	...
	var Utils = /** @class */ (function () {
	    ...
	    Utils.getSourceSite = function (forceLocal) {
	        ...
	        // Funky spil fix to bypass their gameplayer.io
	        if (Branding$$1.isSpil()) {
	            host = Utils.getReferrer(host);
	        }
	...
	var GoogleAnalytics = /** @class */ (function () {
	    ...
	    GoogleAnalytics.preload = function () {
	        if (Branding$$1.analyticsEnabled) {
	            return new Promise(function (resolve, reject) {
	                // We force https on app builds to mmake it work
	                var protocol = Utils.isOnDevice() ? 'https://' : '//';
	    ...
	    GoogleAnalytics.prototype.setup = function (analyticsId, appName, appVersion, trackerWrapper, sampleRate) {
	        ...
	        ga('create', analyticsId, trackerWrapper, {
	            sampleRate: sampleRate
	        });
	        if (Utils.isOnDevice()) {
	            // google by default ignores request comming from file://, doing this overrides that check
	        ...
	        if (trackerWrapper !== 'auto') {
	            ...
	            ga('create', 'UA-60359297-50', settings);
	        }
	        else {
	            ga('create', 'UA-60359297-50', trackerWrapper, 'fbrq', {
	                sampleRate: 1
	            });
	        }
	        if (Branding$$1.isSpil()) {
	            var referrer = Utils.getReferrer(decodeURIComponent(document.referrer));
	            ga('fbrq.set', 'referrer', referrer);
